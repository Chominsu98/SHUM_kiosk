    ...
    <div id="popup" class="hide">
        <div class="content">
            ...
            <div class="d-grid gap-2 mx-auto">
                <button class="btn btn-primary button-color" onclick="closePopup()" id="close"><i class="zmdi zmdi-check-circle"></i>확인</button>
            </div>
        </div>
    </div>
...
<script>
    ...
    let state='<c:out value="${haveTicket}"></c:out> ';
